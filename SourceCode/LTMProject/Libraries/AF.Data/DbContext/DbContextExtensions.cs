...
namespace AF.Data.DbContext 
{
    public static class DbContextExtensions
    {
        ...
        private static T InnerGetCopy<T>(IDbContext context, T currentCopy, Func<DbEntityEntry<T>, DbPropertyValues> func) where T : BaseEntity
        {
            ...
            System.Data.Entity.DbContext dbContext = CastOrThrow(context);
        ...
        /// <returns></returns>
        private static DbEntityEntry<T> GetEntityOrReturnNull<T>(T currentCopy, System.Data.Entity.DbContext dbContext) where T : BaseEntity
        {
            return dbContext.ChangeTracker.Entries<T>().FirstOrDefault(e => e.Entity == currentCopy);
        }

        private static System.Data.Entity.DbContext CastOrThrow(IDbContext context)
        {
            var output = context as System.Data.Entity.DbContext;

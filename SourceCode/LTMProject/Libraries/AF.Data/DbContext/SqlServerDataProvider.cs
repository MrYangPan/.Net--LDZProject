...
namespace AF.Data.DbContext
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have  2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<AFObjectContext>(tablesToValidate, customCommands.ToArray());

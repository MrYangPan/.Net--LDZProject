...
{
    /// <summary>
    /// Provides access to the singleton instance of the Af engine.
    /// </summary>
    public class EngineContext
    {
        ...
        /// <summary>
        /// Initializes a static instance of the Af factory.
        /// </summary>
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("AFConfig") as AFConfig;
                Singleton<AFConfig>.Instance = config;
        ...
        /// <summary>
        /// Gets the singleton Af engine used to access AF services.
        /// </summary>

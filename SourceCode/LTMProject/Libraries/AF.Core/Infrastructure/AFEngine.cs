...
namespace AF.Core.Infrastructure
{
    ...
    public class AFEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(AFConfig config)
        {
            ...
            builder.RegisterInstance(config).As<AFConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(AFConfig config)
        {
            //register dependencies

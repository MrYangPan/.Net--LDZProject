    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteWebConfig()
        {
            try
            {
                ...
                File.SetLastWriteTime(MapPath("~/web.config"), DateTime.Now);
                return true;
            }
            catch
            {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                ...
                //The issue is described here: http://www.application.com/boards/t/10969/nop-20-plugin.aspx?p=4#51318
                //The solution is to touch global.asax file
                File.SetLastWriteTime(MapPath("~/global.asax"), DateTime.Now);
                return true;
            }
            catch
            {
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.application.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new AFException("application needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["af.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["af.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["af.IsPOSTBeingDone"] = value;
            }
        }

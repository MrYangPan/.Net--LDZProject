...
using AF.Domain.Domain.Logging;

namespace AF.Services.Logging
{
    /// <summary>
    /// Default logger
    /// </summary>
    public partial class DefaultLogger : ILogger
    {
        ...
        /// Gets all log items
        /// </summary>
        /// <param name="fromDT">Log item creation from; null to load all records</param>
        /// <param name="toDT">Log item creation to; null to load all records</param>
        /// <param name="message">Message</param>
        ...
        /// Log item items
        /// </returns>
        public virtual IPagedList<Log> GetAllLogs(DateTime? fromDT = null, DateTime? toDT = null,
            string message = "", LogLevel? logLevel = null, 
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            var query = _logRepository.Table;
            if (fromDT.HasValue)
                query = query.Where(l => fromDT.Value <= l.CreatedOn);
            if (toDT.HasValue)
                query = query.Where(l => toDT.Value >= l.CreatedOn);
